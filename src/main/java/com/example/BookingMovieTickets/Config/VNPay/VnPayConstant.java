package com.example.BookingMovieTickets.Config.VNPay;

public class VnPayConstant {

    public static final String VNP_PAY_URL = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    public static final String VNP_RETURN_URL = "http://localhost:8080/user/callback";
    public static final String VNP_TMN_CODE = "K95ZRSZV";
    public static final String SECRET_KEY = "EYHDDVZBTXWCCYVLSRHAXFGPGODACXZF";
